...
const ClusterAssignments = () => {
  ...
  useEffect(() => {
    ...
    if (storedTab) {
      ...
      if (storedTab === "view") {
        ...
        setStatusFilter("all");
        dispatch(getClusterDropDown(""));
        dispatch(getClusterAssignment({ startDate, endDate, vehicleNo: "" }));
      }
  ...
  const handleResetFilters = () => {
    ...
    setEndDate(endDateStr);
    dispatch(getClusterDropDown(""));
    dispatch(getClusterAssignment({ startDate: startDateStr, endDate: endDateStr, vehicleNo: "" }));
  };
          ...
          <div className="bg-white p-6 rounded shadow border border-gray-200 mt-6">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid gap-6 grid-cols-1 md:grid-cols-2 xl:grid-cols-4 pb-5">
                ...
                <div className="flex flex-col">
                  <label className="mb-1 text-sm font-medium text-gray-700">Assignment Date</label>
                  <input
                    type="date"
