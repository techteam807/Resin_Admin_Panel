...
import {
  ...
  restoreProduct,
  createProductFlag,
} from "@/feature/product/productSlice"; // Import your Redux actions
...
const ProductDesign = () => {
  ...
  const [inspectionDueDialogOpen, setInspectionDueDialogOpen] = useState(false); // New state for Inspection Due dialog

  // Initialize productFlags with backend data
  useEffect(() => {
    const initialFlags = {};
  ...
  return (
    <div className="">
            ...
            <div className="mb-3 flex flex-row md:items-center justify-between md:gap-8">
              ...
              <div className="flex shrink-0 gap-2 flex-row">
                ...
                <Button
                  ...
                  className="flex items-center gap-2 w-full h-max py-3 sm:w-max"
                  size="sm"
                >
          ...
          {loading ? (
            ...
            <div className="grid md:grid-cols-3 gap-7 items-start p-4 border-t mt-5 pt-5 border-blue-gray-100">
                          ...
                          <div className="flex items-start justify-between">
                            <div className="p-1.5 flex items-center">
                              ...
                              <div className="ps-2">
                                ...
                                {active === true && (
                                  <div className="flex items-center justify-between mt-3 p-3 rounded-lg border border-gray-200 bg-white shadow-sm hover:shadow transition-all">
                                    {/* Left: Flag button */}
                                    <button
                                      onClick={(e) => {
                                        e.stopPropagation();
                                      ...
                                      className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold transition-all duration-200 transform
                                    ...
                                    <div className="flex items-center gap-3">
                                      <span className="text-sm text-gray-600 font-medium pl-3">Flags:</span>
              ...
              {active === "inspectionDue" && (
                <div className="border border-blue-gray-100 bg-[#f4f5f7] rounded-md col-span-3">
                  ...
                  <div className="space-y-3 p-3 h-[74vh] overflow-y-auto scrollbar-custom-orange">
      ...
      {/* New Dialog for Inspection Due Notification */}
